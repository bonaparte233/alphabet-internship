    ...
    <v-row class="trending-list">
      <v-col cols="12" md="6">
        <v-list class="trending-list" lines="two">
          <v-list-item v-for="item in trendingItems.slice(0, 6)" :key="item.id" active-class="active-list-item">
            <template #prepend>
              <v-avatar size="48">
            ...
            <div class="list-item-content">
              ...
              <div class="subtitle">{{ item.artist }} • {{ item.views }} views</div>
            </div>
          </v-list-item>
        </v-list>
      </v-col>
      ...
      <v-col cols="12" md="6">
        <v-list class="trending-list" lines="two">
          <v-list-item v-for="item in trendingItems.slice(6, 12)" :key="item.id" active-class="active-list-item">
            <template #prepend>
              <v-avatar size="48">
                <v-img :src="item.thumbnail"></v-img>
              </v-avatar>
